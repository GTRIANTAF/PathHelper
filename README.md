...
1.  **Local Scraper & CLI AI assistant (CLI Tool):**
    * Τρέχει τοπικά στον υπολογιστή του χρήστη για μέγιστη ασφάλεια. Συνδέεται στο "Progress" και εξάγει τους βαθμούς σε ένα αρχείο `my_grades.json`.
    * CLI llama 3.2 based AI assistant το οποίο τρέχει στο CLI
